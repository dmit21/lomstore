...
window.onload = function () {
  $.ajax({
    ...
    success: function(html1) {
      ...
      document.getElementById("Adres").innerHTML = 'Адрес: ' + rez[1];
      document.getElementById("Phone").innerHTML = 'Телефон: ' + rez[2];
      document.getElementById("MyZag").innerHTML =  rez[0] + "<br> Авансовый отчет на дату " + MySqlDateToStr(rez[3]);
