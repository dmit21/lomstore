  ...
  $.ajax({
    ...
    success: function(html1) {
      ...
      if(aact==1){
        ...
        cell7.innerHTML = 'Цена за гр';
        cell8 = row.insertCell(8);
        cell8.innerHTML = 'Стоим.';
        cell9 = row.insertCell(9);
        cell9.innerHTML = 'Магазин';
        cell10 = row.insertCell(10);
        cell10.innerHTML = 'Эксперт-оцещик';
      }
      else{
        cell7 = row.insertCell(7);
      ...
      for (i=0;i<n;i++){
        ...
        if(aact==1){
          cell7 = row.insertCell(7);
          cell7.innerHTML = garr[i][13];

          stoim = Math.round(garr[i][13]*garr[i][5]/100)*100;
          cell8 = row.insertCell(8);
          cell8.innerHTML = stoim;
          sums = Number(sums)+Number(stoim);

          cell9 = row.insertCell(9);
          cell9.innerHTML = garr[i][12];
    
          cell10 = row.insertCell(10);
          cell10.innerHTML = garr[i][9];
        }
        else{
          cell7 = row.insertCell(7);
