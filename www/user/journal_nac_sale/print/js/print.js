...
window.onload = function MyPrint() {
  $.ajax({
    ...
    success: function(html1) {
      ...
      document.getElementById('StNum').innerHTML = storname;
      document.getElementById('MyPrintZag').innerHTML = 'Реализация залогового имущества № '+nacname+' от '+MySqlDateToStr(arr[3]);
